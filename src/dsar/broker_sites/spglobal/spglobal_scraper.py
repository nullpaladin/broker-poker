...
async def submit_request(tab, request_type, label, super_scraper):
    ...
    await tab.take_screenshot(f"resources/screenshots/spglobal_dry_run_{label}.png")
    print(f"Screenshot saved to resources/screenshots/spglobal_dry_run_{label}.png")
